...
export CROSS_COMPILE=/home/ruturaj/git/toolchain/UBERTC-aarch64-linux-android-4.9-kernel/bin/aarch64-linux-android-;
	...
	if [ -e "$KERNELDIR"/arch/arm64/boot/Image.gz-dtb ]; then
		cp arch/arm64/boot/Image.gz-dtb READY-KERNEL/boot/
		...
		#echo "Create dt.img................"
		#./scripts/dtbTool -v -s 2048 -o READY-KERNEL/boot/dt.img arch/arm64/boot/dts/
